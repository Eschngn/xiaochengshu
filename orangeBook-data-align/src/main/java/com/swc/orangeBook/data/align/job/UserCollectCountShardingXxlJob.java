...
/**
 * @author Wilson
 * @Description: 定时分片广播任务：对当日发生变更的用户收藏数进行对齐
 * @date 2024/11/19 0:21
 */
@Component
@Slf4j
    ...
    public void userCollectCountShardingJobHandler() throws Exception {
        ...
        for (; ; ) {
            ...
            userIds.forEach(userId -> {
                ...
                int userCollectTotal = selectMapper
                        .selectUserCollectCountFromNoteCollectionAndNoteTableByUserId(userId);
