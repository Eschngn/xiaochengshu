package com.swc.orangeBook.user.biz.service.impl;
...
import com.swc.framework.common.enums.DeleteEnum;
...
import com.swc.framework.common.util.ParamUtil;
import com.swc.orangeBook.oss.api.FileFeignApi;
import com.swc.orangeBook.user.biz.constant.RedisKeyConstants;
import com.swc.orangeBook.user.biz.constant.RoleConstants;
import com.swc.orangeBook.user.biz.domain.dataobject.RoleDO;
import com.swc.orangeBook.user.biz.domain.dataobject.UserDO;
import com.swc.orangeBook.user.biz.domain.dataobject.UserRoleDO;
import com.swc.orangeBook.user.biz.domain.mapper.RoleDOMapper;
import com.swc.orangeBook.user.biz.domain.mapper.UserDOMapper;
import com.swc.orangeBook.user.biz.domain.mapper.UserRoleDOMapper;
import com.swc.orangeBook.user.biz.enums.ResponseCodeEnum;
import com.swc.orangeBook.user.biz.enums.SexEnum;
import com.swc.orangeBook.user.biz.model.vo.UpdateUserInfoReqVO;
import com.swc.orangeBook.user.biz.rpc.DistributedIdGeneratorRpcService;
import com.swc.orangeBook.user.biz.rpc.OssRpcService;
import com.swc.orangeBook.user.biz.service.UserService;
import com.swc.orangeBook.user.dto.req.*;
...
public class UserServiceImpl implements UserService {
    ...
    public Response<Long> register(RegisterUserReqDTO registerUserReqDTO) {
        ...
        // 否则注册新用户
        // 获取全局自增的小橙书 ID
        //Long xiaochengshuId = redisTemplate.opsForValue().increment(RedisKeyConstants.XIAOCHENGSHU_ID_GENERATOR_KEY);
        // RPC: 调用分布式 ID 生成服务生成小橙书 ID
        ...
        UserDO userDO=UserDO.builder()
                .id(userId)
                .phone(phone)
                .xiaochengshuId(xiaochengshuId)//自动生成小橙书号 ID
                .nickname("小橙薯"+xiaochengshuId)// 自动生成昵称, 如：小橙薯10000
    ...
    public Response<FindUserByIdRspDTO> findById(FindUserByIdReqDTO findUserByIdReqDTO) {
        ...
        threadPoolTaskExecutor.submit(()->{
            ...
            redisTemplate.opsForValue()
                    .set(userInfoRedisKey,JsonUtil.toJsonString(findUserByIdRspDTO),expireSeconds, TimeUnit.SECONDS);
        });
    ...
    public Response<List<FindUserByIdRspDTO>> findByIds(FindUsersByIdsReqDTO findUsersByIdsReqDTO) {
        ...
        if (CollUtil.isNotEmpty(redisValues)) {
            findUserByIdRspDTOS = redisValues.stream()
                    ...
                    .collect(Collectors.toCollection(ArrayList::new)); // 使用 ArrayList 确保可变性
        }
            ...
            threadPoolTaskExecutor.submit(() -> {
                ...
                redisTemplate.executePipelined((RedisCallback<Void>) connection -> {
                    for (UserDO userDO : userDOS) {
                        ...
                        String value = JsonUtil.toJsonString(findUserInfoByIdRspDTO);
