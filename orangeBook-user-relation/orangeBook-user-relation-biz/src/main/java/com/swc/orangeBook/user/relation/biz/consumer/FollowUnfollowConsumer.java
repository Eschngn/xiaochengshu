package com.swc.orangeBook.user.relation.biz.consumer;
...
import com.swc.orangeBook.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.swc.orangeBook.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 * @author Wilson
 * @Description: TODO
 * @date 2024/9/19 18:35
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaochengshu_group_"+MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
...
public class  FollowUnfollowConsumer implements RocketMQListener<Message> {
    ...
    private void handleFollowTagMessage(String bodyJsonStr) {
        ...
        if(isSuccess){
            ...
            // 时间戳
            long timestamp = DateUtil.localDateTime2Timestamp(createTime);
