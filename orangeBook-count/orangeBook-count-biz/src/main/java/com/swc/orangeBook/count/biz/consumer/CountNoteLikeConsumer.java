...
import com.swc.orangeBook.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.swc.orangeBook.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.swc.orangeBook.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
 ...
 * @date 2024/10/25 23:37
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaochengshu_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
