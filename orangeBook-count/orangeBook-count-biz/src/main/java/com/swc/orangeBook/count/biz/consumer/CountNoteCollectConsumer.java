...
import com.swc.orangeBook.count.biz.constant.RedisKeyConstants;
import com.swc.orangeBook.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.swc.orangeBook.count.biz.model.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.swc.orangeBook.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.swc.orangeBook.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
 ...
 * @date 2024/11/14 23:44
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaochengshu_group_"+ MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
