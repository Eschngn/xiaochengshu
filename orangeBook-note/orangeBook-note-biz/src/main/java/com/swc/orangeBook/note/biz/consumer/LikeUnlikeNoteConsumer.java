 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaochengshu_group_"+ MQConstants.TOPIC_LIKE_OR_UNLIKE, // Group 组
...
public class LikeUnlikeNoteConsumer implements RocketMQListener<Message> {
    ...
    private void handleLikeNoteTagMessage(String bodyJsonStr) {
        // 消息体 JSON 字符串转 DTO
        LikeUnlikeNoteMqDTO likeNoteMqDTO = JsonUtil.parseObject(bodyJsonStr, LikeUnlikeNoteMqDTO.class);
    ...
    private void handleUnlikeNoteTagMessage(String bodyJsonStr) {
        // 消息体 JSON 字符串转 DTO
        LikeUnlikeNoteMqDTO unlikeNoteMqDTO = JsonUtil.parseObject(bodyJsonStr, LikeUnlikeNoteMqDTO.class);
