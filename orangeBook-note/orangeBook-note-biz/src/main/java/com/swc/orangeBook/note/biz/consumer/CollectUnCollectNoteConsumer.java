 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaochengshu_group_" + MQConstants.TOPIC_COLLECT_OR_UN_COLLECT, // Group 组
...
public class CollectUnCollectNoteConsumer implements RocketMQListener<Message> {
    ...
    private void handleUnCollectNoteTagMessage(String bodyJsonStr) {
        // 消息体 JSON 字符串转 DTO
        CollectUnCollectNoteMqDTO unCollectNoteMqDTO = JsonUtil.parseObject(bodyJsonStr, CollectUnCollectNoteMqDTO.class);
